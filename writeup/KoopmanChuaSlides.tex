...
\begin{frame}{Motivation: Linear Tools for Nonlinear Motion}
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \item eigenvalues describe growth, decay, oscillation
...
\begin{frame}{Dictionary Sweep: Accuracy Versus Cost}
    ...
    \begin{alertblock}{Practical conclusion}
        Koopman analysis is not black-box linearization. Physical insight enters through the observable dictionary.
    \end{alertblock}
\end{frame}
